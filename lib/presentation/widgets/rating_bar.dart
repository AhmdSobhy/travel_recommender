...
class RatingBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < 5; i++) {
      if (i < realNumber) {
        _starList.add(Icon(Icons.star_rounded, color: Colors.deepOrange, size: size));
        ...
        _starList.add(SizedBox(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              Icon(Icons.star_rounded, color: Colors.deepOrangeAccent, size: size),//Theme.of(context).primaryColor
              ClipRect(
        ...
        _starList.add(Icon(Icons.star_rounded, color: Colors.grey, size: size));
      }
    }
